...
The first version of this model was presented in my [PhD thesis](https://orca.cardiff.ac.uk/id/eprint/96981/) and, not withstanding certain limitations, allowed to model spike and wave discharges as observed in humans. The second version of the model fixed earlier limitations and extended its application to animal models of spike and wave discharges. Description of the second version of the model have been published in [Paper 1]( https://doi.org/10.1111/cns.14206) and [Paper 2]( https://doi.org/10.1111/cns.14204). The Neuron code describing [version 1](https://github.com/dervinism/thalamocortical1) and [version 2](https://github.com/dervinism/thalamocortical2) of the model is available on Github.
<p> &nbsp; </p>
...
References: [Nevian et al. (2007)](https://www.nature.com/articles/nn1826) and Hardingham et al. (https://www.jneurosci.org/content/30/4/1441).
</span>
<p> &nbsp; </p>
